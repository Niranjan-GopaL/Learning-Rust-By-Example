...
fn _get_theme(theme: Theme) {  // <--------- [[4]] _get_theme() function gets the ownership of my_theme
...
fn _main_ () {
    ...
    let _color = "purple";
    _get_theme(my_theme);  // <------------ [[3]] ownership of that variable is given to the other function
